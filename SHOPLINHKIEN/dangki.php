...
<div class="main">
	<div class="dangki" style='background:url(img/bg.jpg);'>
		...
		<div class="row">
			<div class="col-xs-12">
				<h3 class="dk">ĐĂNG KÍ THÀNH VIÊN <span class='t1'>ID</span> <span class='t2'>SLENDERSHOP</span></h3>
			</div>
	 ...
	 ?>
			<form action="" method="post">
				...
				<div class="col-xs-12">
					...
					<span class="check">Tôi đã đọc và đồng ý với <a href="">Điều Khoản Và Quy Định</a> Của SLENDERSHOP</span>
				</div>
