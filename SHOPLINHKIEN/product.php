		...
		<?php 
			...
			<div class="col-xs-4">
				...
				<div class="col-sm-6 col-md-5 jk khung1">
					...
					<li><p class="stt">Bộ sản phẩm chuẩn: <span>Hộp, Sách hướng dẫn.</span></p></li>
					</ul>
					</div>
					<div class="add">
					...
					<div class="fb-like" data-href="https://www.facebook.com/" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
...
Giá mua trả góp: 18.490.000đ <em>(Áp dụng từ 01/07 đến 31/07/2019)</em><br>- Ưu đãi trả góp: trả trước 0đ, lãi suất 1% (Áp dụng từ 01/07 đến 31/07/2019)</br>- Bảo hành 1 đổi 1 trong 1 tháng nếu hàng lỗi. (Áp dụng từ 01/07 đến 31/07/2020)
                                ...
                                <div class="guarantee" style="margin-top: 0px;">
                                    <table cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>Giao hàng miễn phí (nếu khoảng cách dưới 10km)</td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </div>
		...
		<div class="cmt-fb">
		<div class="container">
		<h4 class='danhgia'>Đánh Giá,Bình Luận Về Sản Phẩm</h4>
			<div class="fb-comments" data-href="https://www.facebook.com/" data-width="100%" data-numposts="10"></div>
		</div>
		</div>
