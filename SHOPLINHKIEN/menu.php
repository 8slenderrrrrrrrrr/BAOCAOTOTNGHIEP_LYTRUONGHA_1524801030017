	...
	<div class="main" style='background: url(img/bg-bluesky.jpg);'>
		...
		<div class="cskh-destop">
			<div class="container">
				...
				<div class="cs2 xxx">
					<ul class='cb2'>
						<li><span class='glyphicon glyphicon-earphone'> Hotline:</span> 0922064596</li>
						<?php
				...
				<div class="cs3 xxx">
					<ul class='cb3'>
						<li><a href="https://www.facebook.com/ishop24hh" target="_blank"><img src="img/face.jpg" alt="" width='20px'></a></li>
			...
			<div class="container">
				...
				<div class="right">
					<ul>
						...
						<ul class="con">
							<li><a href="index.php?page=vga">VGA</a></li>
							<li><a href="index.php?page=maytinh">Máy Tính</a></li>
							<li><a href="index.php?page=hddssd">HDD/SSD</a></li>
							<li><a href="index.php?page=mainboard">MainBoard</a></li>
							<li><a href="index.php?page=psu">PSU</a></li>
							<li><a href="index.php?page=ram">RAM</a></li>
							<li><a href="index.php?page=cpu">CPU</a></li>
						</ul>
						</li>
