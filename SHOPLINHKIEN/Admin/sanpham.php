 ...
 ?>
            ...
            <table width="990px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="30px" id="navbar-title">
                 ...
                 <?php
                    ...
                    $trang=$_GET['trang'];
                    $start=($trang -1) * $size;
                    $sql_sp="select * from sanpham  where chuyen_muc='Linh_Kien' limit $start,$size";
                    $sql_query_sp=mysqli_query($connection,$sql_sp);
                    $sql_row_sp=mysqli_num_rows($sql_query_sp);
                    if(!$trang || $trang<1){
                        header('location:adminstrator.php?page=sanpham&trang=1');
                     }
                    if($sql_row_sp>0){
            ...
            ?>                                       
                <tr class="product-item">
                    ...
                    <td class="link"><a href="adminstrator.php?page=suasanpham&id_sp=<?php echo $row_sp['id_sp'] ?>">sửa</a></td>
...
<td align="right" colspan="12">
                    ...
                    if($trang>1){
                        ...
                        ?>
                         <a style='font-size:14px;color:blue;' href="adminstrator.php?page=sanpham&trang=<?php echo $trang-1 ?>">Pre</a>
                    <?php
                        }
                    ...
                    <?php
                        for($i=1;$i<=$tongsotrang;$i++){
                            if($i==$trang){
                                echo "<a style='color:red;font-size:14px;' href='adminstrator.php?page=sanpham&trang=$i'><b>$i</b></a>";
                            }
                            else{
                                echo "<a style='font-size:14px;color:blue;' href='adminstrator.php?page=sanpham&trang=$i'>$i</a>";
                            }
                        }
                    ...
                    <?php 
                      ...
                      ?>
                      <a style='font-size:14px;color:blue;' href="adminstrator.php?page=sanpham&trang=<?php echo $trang+1 ?>">Next</a>
                      <?php
