...
<title>SLENDERSHOP-ADMINCP</title>
    ...
    <tr id="body">
    	<td align="left" valign="top" width="250px">
            ...
            <table width="300px" class="left-menu" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr class="menu-item" height="30px">
                    <td style='border-bottom: 1px solid #ccc;padding-bottom: 5px; padding-top: 5px;'><a href="adminstrator.php?page=danhmucsp" style='color:#FF6E00;font-size: 13px;font-weight:bold;' >- Quản Lí Danh Mục Sản Phẩm</a></td>
                </tr>
                 <tr class="menu-item" height="30px">
                    <td class='qlsp' style='border-bottom: 1px solid #ccc;padding-bottom: 5px; padding-top: 5px;'><a href="adminstrator.php?page=sanpham" style='color:#FF6E00;font-size: 13px;font-weight:bold;'>- Tất Cả sản phẩm</a>
                ...
                <tr class="menu-item" height="30px">
                    <td><a href="adminstrator.php?page=quanlithanhvien" style='color:#FF6E00;font-size: 13px;font-weight:bold;'>- Quản lý Thành Viên </a></td>
                </tr>
...
<div height="62px">
        <p id="footer" colspan="2" align="center" >SLENDERSHOP-Niềm Tin Cậy Của Người Dùng</p>
    </div>
